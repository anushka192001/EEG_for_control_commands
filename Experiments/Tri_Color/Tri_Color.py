...
class Color(QWidget):
    def __init__(self):
        ...
        self.pixmap1 = QPixmap('K:/OneDrive - iitkgp.ac.in/PhD/Experiments/Color Detection/Tri_Color/Fixation2.png')
        ...
        self.marker_list = [1, 3, 1, 2, 3, 1, 3, 2, 2, 3, 1, 3, 2, 1, 3, 2, 3, 3, 2, 1, 2, 1, 3, 1, 2, 3, 1, 1, 2, 3, 3, 2, 1, 3, 2, 2, 1, 1, 2, 3, 2,
                            1, 2, 3, 1, 1, 2, 1, 3, 1, 3, 2, 1, 3, 3, 2, 1, 2, 2, 3, 1, 2, 3, 3, 2, 1, 2, 3, 1, 2, 3, 1, 1, 2, 3] # 75 items
        ...
        self.filename = 'Tri_Color/events_' + str(self.session_time) + '.txt'
    ...
    def tricolor(self):
        ...
        if self.i < len(self.marker_list):
            if self.marker_list[self.i] == 1:
                ...
                self.Clabel.setStyleSheet('background-color: rgb(0, 255, 0)')
